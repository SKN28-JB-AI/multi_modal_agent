...
# wan-2.6: 2~15초 정수(가변), 네이티브 오디오, 720P/1080P, 멀티샷 지원.
# 공식 문서: duration 은 "wan2.6-t2v: An integer from 2 to 15" (Model Studio
# text-to-video API reference, 2026-06 확인).
register(
    "wan-2.6",
    WanBackend,
    t2v_model="wan2.6-t2v",
    i2v_model="wan2.6-i2v",
    supported_durations=tuple(float(s) for s in range(2, 16)),
    resolutions=("720p", "1080p"),
)
# wan-2.7: 최신 세대. 2~15초 정수(가변), 네이티브 오디오, 720P/1080P,
# 멀티샷·first/last 제어. duration 범위는 wan2.6 과 동일(2~15초, 2026-06 확인).
register(
    "wan-2.7",
    WanBackend,
